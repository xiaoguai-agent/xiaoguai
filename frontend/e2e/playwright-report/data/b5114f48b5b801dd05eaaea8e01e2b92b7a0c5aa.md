...
- Name: admin-ui/golden-path.spec.ts >> admin-ui navigation — all panes >> MCP Servers pane renders heading
- Location: tests/admin-ui/golden-path.spec.ts:84:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/mcp-servers
Call log:
  - navigating to "http://localhost:5174/mcp-servers", waiting until "load"

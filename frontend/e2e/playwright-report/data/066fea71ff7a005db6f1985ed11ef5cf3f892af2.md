...
- Name: admin-ui/golden-path.spec.ts >> admin-ui navigation — all panes >> Usage pane renders heading and controls
- Location: tests/admin-ui/golden-path.spec.ts:46:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/usage
Call log:
  - navigating to "http://localhost:5174/usage", waiting until "load"

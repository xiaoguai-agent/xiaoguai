...
- Name: admin-ui/golden-path.spec.ts >> admin-ui Scheduler pane — Jobs tab detail >> Create-from-description tab shows textarea
- Location: tests/admin-ui/golden-path.spec.ts:148:3

...
- Name: admin-ui/golden-path.spec.ts >> admin-ui navigation — all panes >> MCP Marketplace pane renders heading
- Location: tests/admin-ui/golden-path.spec.ts:88:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/marketplace
Call log:
  - navigating to "http://localhost:5174/marketplace", waiting until "load"

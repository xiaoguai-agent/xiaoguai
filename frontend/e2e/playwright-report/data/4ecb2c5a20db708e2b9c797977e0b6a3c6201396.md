...
- Name: admin-ui/golden-path.spec.ts >> admin-ui navigation — all panes >> Eval pane renders suite selector area
- Location: tests/admin-ui/golden-path.spec.ts:66:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/eval
Call log:
  - navigating to "http://localhost:5174/eval", waiting until "load"

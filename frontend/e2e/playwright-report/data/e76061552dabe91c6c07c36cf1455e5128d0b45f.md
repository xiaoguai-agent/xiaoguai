...
- Name: chat-ui/chat-hotl-suspend-resume.spec.ts >> chat-ui HotL banner >> partial assistant text is preserved when hotl_pending arrives mid-stream
- Location: tests/chat-ui/chat-hotl-suspend-resume.spec.ts:124:3

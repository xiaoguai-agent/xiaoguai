...
- Name: admin-ui/admin-personas.spec.ts >> admin-ui Personas pane — CRUD against mocked /v1/personas >> name filter narrows visible rows
- Location: tests/admin-ui/admin-personas.spec.ts:166:3

...
- Name: admin-ui/golden-path.spec.ts >> admin-ui navigation — all panes >> Providers pane renders LLM Providers heading
- Location: tests/admin-ui/golden-path.spec.ts:80:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/providers
Call log:
  - navigating to "http://localhost:5174/providers", waiting until "load"

...
- Name: admin-ui/golden-path.spec.ts >> admin-ui language switcher (C19 i18n — landed) >> switching to zh-CN re-renders the nav title in Chinese
- Location: tests/admin-ui/golden-path.spec.ts:160:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/today
Call log:
  - navigating to "http://localhost:5174/today", waiting until "load"

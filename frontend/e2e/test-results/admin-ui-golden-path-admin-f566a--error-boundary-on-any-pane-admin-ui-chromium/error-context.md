...
- Name: admin-ui/golden-path.spec.ts >> admin-ui navigation — all panes >> no uncaught React error boundary on any pane
- Location: tests/admin-ui/golden-path.spec.ts:97:3

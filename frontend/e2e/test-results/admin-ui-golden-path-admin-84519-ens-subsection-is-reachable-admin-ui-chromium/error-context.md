...
- Name: admin-ui/golden-path.spec.ts >> admin-ui Scheduler pane — Jobs tab detail >> Scheduler Tokens subsection is reachable
- Location: tests/admin-ui/golden-path.spec.ts:139:3
